...
class SquaredRegisterRepository(object):
    def __new__(cls):
        if not hasattr(cls, 'instance'):
            cls.instance = super(SquaredRegisterRepository, cls).__new__(cls)
        return cls.instance
    ...
    def get(self, from_date, to_date, is_sypra):
        ...
        query = f'''
            SELECT local_id, numero_caja, vendedor_id, fecha_caja, empresa, total, efectivo_cuadre, efectivo_real,
             cigarros_cuadre, cigarros_real, debito_cuadre, debito_real, credito_cuadre, credito_real ,estado, mlocal.nombre 
        ...
        rows = [SquaredRegister(local_id=i[0], numero_caja=i[1],vendedor_id=i[2], fecha_caja=i[3], empresa_id=i[4],
                                total=i[5], efectivo_cuadre=i[6], efectivo_real=i[7], cigarros_cuadre=i[8],
                                cigarros_real=i[9], debito_cuadre=i[10], debito_real=i[11], credito_cuadre=i[12],
                                credito_real=i[13],  estado=i[14], local_name=i[15]
    ...
    def add(self, squared_register: SquaredRegister):
        query = f'''
            ...
            efectivo_real, cigarros_cuadre, cigarros_real, debito_cuadre, debito_real, credito_cuadre, credito_real, estado)
            ...
            '{squared_register.fechaCaja}', {squared_register.empresaId}, {squared_register.total }, {squared_register.efectivoCuadre},
             {squared_register.efectivoReal}, {squared_register.cigarrosCuadre}, {squared_register.cigarrosReal},
             {squared_register.debitoCuadre}, {squared_register.debitoReal}, {squared_register.creditoCuadre},
